...
// const BurmeseResponseGenerator = () => {
...
//     const prompt = `
//         You will receive a topic in English and will return a translated text output in Burmese, pinyin, and english on the topic. 
//         In your response, make the sentences humanlike, use common grammar patterns and sentence structure in Burmese, and proper punctuation. 
//         The completion should be ${responseLength} sentences for each mode of output (Burmese, Pinyin, and English).
...
//       <div>
//         <button onClick={() => setSelectedPage("One")}>Burmese</button>
//         <button onClick={() => setSelectedPage("Two")}>
//           Burmese and Pinyin
//         </button>
//         <button onClick={() => setSelectedPage("Three")}>
//           Burmese, Pinyin, and English
//         </button>
//       </div>
...
// export default BurmeseResponseGenerator;

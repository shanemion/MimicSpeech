...
const JapaneseResponseGenerator = () => {
  ...
  const handleGenerateResponse = async () => {
    const prompt = `
        You will receive a topic in English and will return a translated text output in Japanese, romanji, and english on the topic. 
        In your response, make the sentences humanlike, use common grammar patterns and sentence structure in Japanese, and proper punctuation. 
        The completion should be ${responseLength} sentences for each mode of output (Japanese, romanji, and English).
  ...
  return (
    <div>
      ...
      <div>
        <button onClick={() => setSelectedPage("One")}>Japanese</button>
...
export default JapaneseResponseGenerator;
